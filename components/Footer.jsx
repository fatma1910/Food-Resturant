            ...
            <div className="flex flex-col xl:flex-row justify-between">
                ...
                <div className="flex-1 grid grid-cols-1 xl:grid-cols-3 gap-[50px] mb-8 xl:mb-16">
                    <div>
                        ...
                        <ul className="flex flex-col justify-between gap-y-6 text-sm">
                            <li>
                                <Link href='/'>Sit pellentesque neque egestas quis dolor, sit
                                </Link>
                            </li>
                            <li>
                                <Link href='/'>Arcu et tincidunt dictum nunc ut nisi, dolor euismod
                                </Link>
                            </li>
                            <li>
                                <Link href='/'>Tempor, volutpat nulla sed posuere orci ac diam integer
                                </Link>
                            </li>
                            <li>
